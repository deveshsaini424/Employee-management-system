  ...
  return (
    <div className='flex mt-10 justify-between gap-5 screen'>
        ...
        <div className='rounded-xl w-[45%] px-9 py-6 bg-blue-400'>
            <h2 className='text-3xl font-semibold'style={{ color: '#000' }}>{data.taskCount.completed}</h2>
            <h3 className='text-xl font-medium'style={{ color: '#000' }}>Completed</h3>
        </div>
        <div className='rounded-xl w-[45%] px-9 py-6 bg-green-400'>
            <h2 className='text-3xl font-semibold'>{data.taskCount.active}</h2>
            <h3 className='text-xl font-medium'>Accpted</h3>
        </div>
